BOT_TOKEN = "1455:AAE4qFS3nF-0Tn" # Get one from @BotFather
API_ID = 69 # Get variable from my.telegram.org
API_HASH = "e46b6c854d2bf580" # Get variable from my.telegram.org
OWNER_ID = 1243703097 # Enter id not username
MAIN_CHATS = [-1001485393652]  # NOTE These are the chats where main functions of bot will work, like music downloading etc.
SUDO_USER_ID = [51635132416, 1342121354245, 23452465243]
SUDO_CHAT_ID = [354165569, 564426514, 686215463]
