from AsunaBot import app, SUDOERS
from AsunaBot.utils.filter_groups import global_stats_group
from AsunaBot.utils.errors import capture_err
from AsunaBot.utils.botinfo import BOT_ID, BOT_NAME
...
async def global_stats(_, message):
    ...
    url = "https://api.github.com/repos/thehamkercat/AsunaBot/contributors"
    rurl = "https://github.com/thehamkercat/AsunaBot"
