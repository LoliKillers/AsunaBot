...
from AsunaBot import app, FERNET_ENCRYPTION_KEY
from AsunaBot.utils import random_line
from AsunaBot.utils.json_prettify import json_prettify
from AsunaBot.utils.fetch import fetch
from AsunaBot.utils.nekobin import neko
...
async def commit(_, message):
    await message.reply_text((await random_line('AsunaBot/utils/commit.txt')))
...
async def runs(_, message):
    await message.reply_text((await random_line('AsunaBot/utils/runs.txt')))
